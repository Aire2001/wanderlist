...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('accounts', '0003_destination_created_at_destination_status_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='destination',
            name='status',
            field=models.CharField(choices=[('planned', 'Planned'), ('visited', 'Visited'), ('dreaming', 'Dreaming')], default='planned', max_length=20),
        ),
    ]
