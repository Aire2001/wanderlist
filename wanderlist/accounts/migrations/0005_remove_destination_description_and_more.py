...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('accounts', '0004_alter_destination_description_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='destination',
            name='status',
            field=models.CharField(choices=[('wishlist', 'Wishlist'), ('visited', 'Visited')], default='wishlist', max_length=50),
        ),
    ]
